 ...
 */
package com.example.yuan.app16.util.runtimepermissions;
...
public class PermissionsManager {
  ...
  private synchronized String[] getManifestPermissions(@NonNull final Activity activity) {
    ...
    try {
      ...
      Log.d(TAG, "包管理器: "+activity.getPackageManager().getClass().getName());//android.app.ApplicationPackageManager
